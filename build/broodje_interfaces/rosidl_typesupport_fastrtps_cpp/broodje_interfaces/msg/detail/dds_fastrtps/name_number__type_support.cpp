...
#include "broodje_interfaces/msg/detail/name_number__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = broodje_interfaces::msg::NameNumber;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const broodje_interfaces::msg::NameNumber *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<broodje_interfaces::msg::NameNumber *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NameNumber__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const broodje_interfaces::msg::NameNumber *>(
...
static size_t _NameNumber__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NameNumber(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NameNumber__callbacks = {
...
static rosidl_message_type_support_t _NameNumber__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NameNumber__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_broodje_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<broodje_interfaces::msg::NameNumber>()
{
  return &broodje_interfaces::msg::typesupport_fastrtps_cpp::_NameNumber__handle;
}
