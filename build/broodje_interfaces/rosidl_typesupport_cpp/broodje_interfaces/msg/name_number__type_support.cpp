...
static const _NameNumber_type_support_symbol_names_t _NameNumber_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, broodje_interfaces, msg, NameNumber)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, broodje_interfaces, msg, NameNumber)),
  }
};
...
{
  return &::broodje_interfaces::msg::rosidl_typesupport_cpp::NameNumber_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, broodje_interfaces, msg, NameNumber)() {
  return get_message_type_support_handle<broodje_interfaces::msg::NameNumber>();
}
